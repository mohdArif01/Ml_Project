...
class DataTranformationConfig:
    preprocessor_obj_file_path = os.path.join('artifact','prepocessor.pkl')

class DataTranformation:
    def __init__(self):
        # Taking the path in the below variable
        self.data_tranformation_config = DataTranformationConfig()

    # For Feature Engineering - Data Transformation Functionality
